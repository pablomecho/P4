...
if [[ $# != 4 ]]; then #Asegura el numero de parametros para la función
...
sox $inputfile -t raw -e signed -b 16 - | $X2X +sf | $FRAME -l 240 -p 80 | $WINDOW -l 400 -L 512 |
	$MFCC -l 400 -m $mfcc_order -n $nfilter > $base.mfcc || exit 1
